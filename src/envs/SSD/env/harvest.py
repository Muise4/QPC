        ...
        for i in range(len(self.apple_points)):
            ...
            if [row, col] not in agent_positions and self.world_map[row, col] != b"A":
                ...
                if not self.more_com:
                    spawn_prob = SPAWN_PROB1[min(num_apples, 3)]
                elif self.more_com:
                    spawn_prob = SPAWN_PROB_COM[min(num_apples, 3)]
