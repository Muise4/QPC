def add_default_args(parser):
    ...
    parser.add_argument(
        "--eager_mode",         # 是否进行急切模式，即是否如pytorch一样立刻执行，会变慢，但True则可以直接看数据了
        action="store_true",
        default=False,
    ...
    parser.add_argument(
        "--tune_hparams",       # 这里实际上就是对reuse_actors的设置，可以设置reuse_actors=True
        action="store_true",
        default=True,
    ...
    parser.add_argument(
        "--ray_results",
        type=str,
        default='/home/liangqifan/file/SSD/sequential_social_dilemma_games/ray_results/',
        help="path of result",
    )
